...
- • Nmap: TCP/UDP port scanning, service version detection ( -sV ), OS detection ( -O ),
- script scanning ( -sC ).
...
- • Practice basic Nmap scans against vulnerable VMs (e.g., Metasploitable /).
