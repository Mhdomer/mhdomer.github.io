...
math: false
mermaid: false
image: https://tryhackme-images.s3.amazonaws.com/room-icons/6131132af49360005df01ae3-1717498281351
...
1) first list the interfaces available 

```
ubuntu@ip-10-48-134-136:~/Desktop/exercise-files$ 
ubuntu@ip-10-48-134-136:~/Desktop/exercise-files$ sudo tshark -D
...
user@ubuntu$ tshark -r write-demo.pcap 
    1   0.000000 145.254.160.237 ? 65.208.228.223 TCP 3372 ? 80 [SYN] Seq=0 Win=8760 Len=0 MSS=14
```
